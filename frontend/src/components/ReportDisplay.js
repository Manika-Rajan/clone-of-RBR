import React, { useContext, useState, useEffect, useRef } from 'react';
   ...
   const ReportsDisplay = () => {
     ...
     const [localIsLogin, setLocalIsLogin] = useState(isLogin); // Local state workaround
     ...
     const handleLoginClose = (loggedIn) => {
       ...
       if (loggedIn) {
         ...
         setLocalIsLogin(true); // Set local state on successful login
         console.log("Forcing re-render and updating localIsLogin");
         setTimeout(() => {
