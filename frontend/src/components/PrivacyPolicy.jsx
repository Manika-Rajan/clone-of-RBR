...
const ProfilePage = () => {
  ...
  const location = useLocation(); // Added to access state from navigation
  ...
  useEffect(() => {
    ...
    // Show toast if coming from successful payment
    if (location.state?.showSuccess) {
      toast.success(
        'Purchase successful! Please view your report under "Purchased Reports" segment below, in the "your profile" page.',
        {
          position: 'top-center',
          autoClose: false,
          closeOnClick: false,
          closeButton: true, // Adds an "OK" button
          onClose: () => {
