...
const Career = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setError('');
    alert('Resume submitted successfully!'); // Replace with API call
  };

  return (
    <div className="container career-container">
      <h2 className="text-center my-4">Careers at Rajan Business Ideas</h2>
      <div className="row">
        {/* Left: Job Listings */}
        <div className="col-md-6 col-12 mb-4">
          <h3>Job Openings by Region</h3>
          {jobsByRegion.map((region) => (
            <div key={region.region} className="region-section">
              ...
              {region.jobs.length > 0 ? (
                ...
                <p>No openings currently available in {region.region}.</p>
              )}
            </div>
          ))}
        </div>
